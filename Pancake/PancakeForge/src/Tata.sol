...
contract CoinToken is Context, IBEP20, Ownable {
    ...
    mapping (address => bool) public _isCharity;
    ...
    function tokenFromReflection(uint256 rAmount) public view returns(uint256) {
        // console.log("Balance Of", rAmount);
        require(rAmount <= _rTotal, "Amount must be less than total reflections");
        uint256 currentRate =  _getRate();
        // console.log("Rate", currentRate);
        // console.log("End", rAmount.div(currentRate));
    ...
    function _transferStandard(address sender, address recipient, uint256 tAmount) private {
        ...
        // console.log("tBurn", tBurn);
        // console.log("tCharity", tCharity);  
        // console.log("rFee", rFee);
        // console.log("rBurn", rBurn);
        // console.log("rCharity", rCharity);   
