...
contract PancakePair is Test {
    ...
    //     console.log(
    //         IERC20(0x8C48D050e618e715b35a0e1e03C3B590001121cf).balanceOf(0x2AD88B3a84E259f4C0828C18ca246fAf206d2A82)
    //     );
    // }

    function test_addliquidity() public {
        // IUniswapV2Factory(PancakeFactory).createPair(address(tokenA), address(tokenB));
